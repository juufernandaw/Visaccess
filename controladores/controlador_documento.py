        ...
        for documento in self.__documento_DAO.get_all_documentos():
            if self.localiza_documento_pelo_nome(documento_alterado['nome']):
                ...
                if documento_alterado['nome'] == documento['nome']:
                    botao, documento_novo = self.__tela_documento.alterar_documento(documento_alterado['nome'], documento['regra'])
                    if botao == 'Voltar':
                        return self.abre_tela_cadastro_documentos()
                    if self.verifica_informacoes_preenchidas(documento_novo['nome'], documento_novo['regra']):
                        if self.localiza_documento_pelo_nome(documento_novo['nome']) and documento_novo['nome'] != documento_alterado['nome']:
                            ...
                            self.__documento_DAO.altera_documento(documento_novo['nome'], documento_novo['regra'], documento_alterado['nome'])
