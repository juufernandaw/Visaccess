...
from persistencia.documentoDAO import TesteDAO
                    ...
                    if dados_novos != None:
                        if dados_novos[0] and dados_novos['-DATE-'] != '' and dados_novos['-DOCUMENTOS-'] != []:
                            ...
                            if teste == None or teste['nome'] == dados_novos[0]:
                                ...
                                self.tipos_vistoDAO.cadastrar_documentos_para_visto(dados_novos['-DOCUMENTOS-'], dados_novos[0])
