...
class TelaTipoVisto:
    ...
    def componentes_tela_cadastro_tipos_visto(self):
        layout = [
            ...
            [interface_tela_tipos_visto.Radio('Excluir Tipo de Visto', "componentes_tela_cadastro_tipos_visto",
                                              key='2')],
            [interface_tela_tipos_visto.Radio('Listar Tipos de Visto', "componentes_tela_cadastro_tipos_visto",
                                              key='3')],
            [interface_tela_tipos_visto.Radio('Modificar Tipo de Visto', "componentes_tela_cadastro_tipos_visto",
                                              key='4')],
